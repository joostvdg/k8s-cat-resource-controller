...
import (
	...
	versioned "github.com/joostvdg/k8s-cat-resource-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/joostvdg/k8s-cat-resource-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/joostvdg/k8s-cat-resource-controller/pkg/client/listers/manifest/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ManifestV1().Manifests(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ManifestV1().Manifests(namespace).Watch(options)
			},
		},
		&manifestv1.Manifest{},
		resyncPeriod,
...
func (f *manifestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&manifestv1.Manifest{}, f.defaultInformer)
}
