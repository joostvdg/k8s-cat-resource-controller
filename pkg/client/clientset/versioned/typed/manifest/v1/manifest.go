...
import (
	...
	scheme "github.com/joostvdg/k8s-cat-resource-controller/pkg/client/clientset/versioned/scheme"
...
func newManifests(c *ManifestV1Client, namespace string) *manifests {
	return &manifests{
		client: c.RESTClient(),
		ns:     namespace,
	}
